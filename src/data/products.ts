...
export const products: Product[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "মাইক্রো-গার্ড প্রটেকশন ব্লেড যা আপনার সংবেদনশীল ত্বককে রক্ষা করে।",
      "সহজে বহনযোগ্য এবং সুরক্ষার জন্য রয়েছে ব্লেড ক্যাপ।"
    ],
    longBenefitsTitle: "আমাদের ফেস রেজার কেন অনন্য?",
    longBenefits: [
      "উচ্চমানের সুইডিশ স্টেইনলেস স্টিল ব্লেড যা দীর্ঘস্থায়ী ধার নিশ্চিত করে।",
    ...
    description: "পার্লারে গিয়ে সুতো দিয়ে থ্রেডিং করার অসহ্য ব্যথাকে বলুন বিদায়! আমাদের ৩ পিসের প্রিমিয়াম ফেস রেজার সেটটি দিয়ে আপনি ঘরে বসেই খুব সহজে এবং ব্যথামুক্তভাবে আপনার আইব্রো প্লাক, আপার লিপ, এবং কপালে গজানো অতিরিক্ত লোম পরিষ্কার করতে পারবেন। এর মাইক্রো-গার্ড ব্লেড ব্যবহারে কেটে যাওয়ার কোনো ভয় নেই।",
    specs: [
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "০৭ জুলাই, ২০২৬",
        comment: "পার্লারের ব্যথা সহ্য করতে হতো আগে, এখন এই রেজার দিয়ে খুব সহজে আইব্রো ঠিক করে ফেলি। ব্লেড অনেক সেফ, কাটার ভয় নেই একদম। রিকমেন্ডেড!",
        verified: true
      }
    ]
  },
